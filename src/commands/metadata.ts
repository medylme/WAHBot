...
export const ChatCommandMetadata: {
    ...
    */
    ...
    STARTAUCTION: {
        ...
        name: 'startauction',
        name_localizations: undefined,
        description: 'Starts an auction in the current text channel.',
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: '8',
    },
    PAUSEAUCTION: {
        ...
        name: 'pauseauction',
        name_localizations: undefined,
        description: 'Queues an ongoing auction to pause.',
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: '8',
    },
    ABORTAUCTION: {
        ...
        name: 'abortauction',
        name_localizations: undefined,
        description: 'Queues an ongoing auction to abort.',
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: '8',
    },
    CLEARTHREADS: {
        ...
        name: 'clearthreads',
        name_localizations: undefined,
        description: 'Clears all threads in the current text channel.',
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: '8',
    },
    BID: {
        ...
        name: 'bid',
        name_localizations: undefined,
        description: 'Places a bid on a player during an auction.',
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: undefined,
        options: [
    ...
    ADDEVENT: {
        ...
        name: 'addevent',
        name_localizations: undefined,
        description: `Adds an event to the current auction to be mentioned by WaffleBot's final report.`,
        description_localizations: undefined,
        dm_permission: false,
        default_member_permissions: '8',
        options: [
